...
public class Application {
	...
	public static void configure(@NonNull JavalinConfig javalin, @NonNull ServiceGraph services) {
		...
		var healthHandler = new HealthHandler(BuildVersion.CURRENT, services.schemaVersion(), services.matchRegistry()::activeCount, services.database()::isReachable, services.clock());
